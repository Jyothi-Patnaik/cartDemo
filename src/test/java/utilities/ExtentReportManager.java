...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		extent.setSystemInfo("Environemnt", "QA Testing");
...
//			  email.setSmtpPort(465);
			  ...
			  email.setAuthenticator(new DefaultAuthenticator("kuppilijyothi999@gmail.com","xawi kxhw vzgy savz")); 
			  email.setStartTLSRequired(true); // Enable TLS
			  //email.setSSLOnConnect(true);
			  email.setFrom("kuppilijyothi999@gmail.com"); //Sender
